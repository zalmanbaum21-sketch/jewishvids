    ...
    finalizeUpload: codeAdminProcedure
      .input(
        z.object({
          ...
          storageUrl: z.string().startsWith("/manus-storage/jewish-videos/"),
          thumbnailKey: z.string().startsWith("jewish-videos/thumbnails/").optional(),
          thumbnailUrl: z.string().startsWith("/manus-storage/jewish-videos/thumbnails/").optional(),
